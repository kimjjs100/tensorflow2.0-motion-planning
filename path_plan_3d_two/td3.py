    ...
    def _train_body(self, states, actions, next_states, rewards, done, weights):
        ...
        with tf.device(self.device):
            with tf.GradientTape(persistent=True) as tape:
                ...
                #critic_2_loss = tf.reduce_mean(huber_loss(td_error2, delta=self.max_grad) * weights)
            ...
            with tf.GradientTape() as tape:
                ...
                actor_loss = - tf.reduce_mean(self.critic([states, next_actions])) + 0.1*tf.reduce_mean(tf.square(self.actor(states)))
...
class Actor(tf.keras.Model):
    def __init__(self, state_shape, action_dim, max_action, name="Actor"):
        ...
        self.l1 = Dense(500, name="L1")

        self.l2 = Dense(400, name="L3")
        self.l3 = Dense(400, name="L3")
        self.l4 = Dense(300, name="L3")
