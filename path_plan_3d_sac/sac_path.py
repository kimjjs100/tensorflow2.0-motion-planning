...
class GaussianActor(tf.keras.Model):
    ...
    def __init__(self, state_shape, action_dim, max_action, hidden_activation="relu",
        ...
        self.l1 = Dense(500, name="L1", activation=hidden_activation)
        #self.l2 = Dense(400, name="L2", activation=hidden_activation)
        #self.l3 = Dense(400, name="L3", activation=hidden_activation)
        #self.l4 = Dense(300, name="L4", activation=hidden_activation)
...
class CriticV(tf.keras.Model):
    def __init__(self, state_shape, name='vf'):
        ...
        self.l1 = Dense(500, name="L1", activation='relu')
        #self.l2 = Dense(400, name="L2", activation='relu')
        #self.l3 = Dense(400, name="L3", activation='relu')
        #self.l4 = Dense(300, name="L4", activation='relu')
